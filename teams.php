...
<head>
  ...
  <style>
    ...
    .team-table th:hover { background: #17a050; }
...
<div class="team-wrapper">
  <h2 class="team-title">Liste des Techniciens</h2>

  <div class="controls">
    <input class="search-box" id="searchInput" type="text" placeholder="🔍 Rechercher un technicien ou service...">
  ...
  <div class="table-container">
    <table class="team-table" id="teamTable">
      <thead>
        <tr>
          <th onclick="sortTable(0)" style="width:45%">
            Nom complet <span class="sort-icon" id="sortIcon0">⇅</span>
          </th>
          <th onclick="sortTable(1)" style="width:55%">
      ...
      <tbody id="tableBody">
        <?php
          $sql = "SELECT U.full_name, U.login, D.name FROM users U, departments D WHERE U.departement=D.id AND U.team_member = 1";
  ...
  function applyFilters() {
    ...
    if (visible === 0) {
      tbody.insertAdjacentHTML('beforeend',
        '<tr id="noResults"><td colspan="2" class="no-results">Aucun résultat trouvé</td></tr>');
    }

    document.getElementById('resultCount').textContent =
      visible + ' technicien' + (visible !== 1 ? 's' : '');
  }
